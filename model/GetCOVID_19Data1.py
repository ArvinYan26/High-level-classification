...
def convertjpg(pngfile, class_num, data, data_target, width=1024, height=1024):
...
def get_data():
    ...
    #读取图片数据，转化为矩阵
    count0 = 0
    path0 = "D:/datasets/covid-19/new_datasets/NORMAL/*.png"
    ...
    count1 = 0
    path1 = "D:/datasets/covid-19/new_datasets/COVID-19/*.png"
    ...
    save.to_csv("C:/Users/Arvin Yan/Desktop/data.csv", index=False, header=True)
    
    # data_target = pd.DataFrame(data_target)
    # data_target.to_csv("C:/Users/Arvin Yan/Desktop/data_taget.csv", index=False, header=True)
